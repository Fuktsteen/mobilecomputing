...
fun MessageCard(msg: Message) {
    Row(modifier = Modifier.padding(all = 30.dp)) {
        Image(
            painter = painterResource(R.drawable.onni),
            contentDescription = "Kontaktin profiilikuva",
            modifier = Modifier
                .size(40.dp)
                .clip(CircleShape)
...
fun PreviewMessageCard() {
    ComposeTutorial2Theme {
        Surface {
            MessageCard(msg = Message("Lexi", "Hei, tsekkaappa Jetpakki Kompoussi, se on mahtava!"))
        }
    }
}
